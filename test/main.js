...
const tate = window.screen.height / (window.devicePixelRatio * window.systemYDPI) * 2.54;
const yoko = window.screen.width / (window.devicePixelRatio * window.systemYDPI) * 2.54;
