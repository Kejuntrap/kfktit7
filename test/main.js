...
const tate = window.screen.height / (window.devicePixelRatio * window.screen.deviceYDPI) * 2.54;
const yoko = window.screen.width / (window.devicePixelRatio * window.screen.deviceXDPI) * 2.54;
